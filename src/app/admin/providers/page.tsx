  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">Hizmet Sağlayıcıları</h1>
          <p className="text-gray-300">Tüm hizmet sağlayıcıları yönet, düzenle ve limitleri ayarla</p>
        </div>
